...
public class Rejected implements FinderStrategy {
    ...
    public List<Booking> findAllByUserId(Long userId) {
        return bookingRepository.findBookingsByUserIdWhereStatus(userId, Status.REJECTED, sort);
    }

    @Override
    public List<Booking> findAllByOwnerId(Long ownerId) {
        return bookingRepository.findBookingsByOwnerIdWhereStatus(ownerId, Status.REJECTED, sort);
    }
